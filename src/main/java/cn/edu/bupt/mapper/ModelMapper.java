...
public interface ModelMapper {
    @Select("select  device_type_id  as deviceTypeId,manufacturer_id as  manufacturerId,model_name as modelName from model where manufacturer_id = #{id} and   device_type_id=#{deviceTypeId} and model_name =#{name}")
    ...
    @Select("select  device_type_id  as deviceTypeId,manufacturer_id as  manufacturerId,model_name as modelName,model_id as modelId from model where 1=1 ")
    List<Model> find();

    @Select("select  device_type_id  as deviceTypeId,manufacturer_id as  manufacturerId,model_name as modelName from model where model_id = #{modelId} ")

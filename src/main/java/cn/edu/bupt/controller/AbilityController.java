...
public class AbilityController extends BaseController{
   ...
   @PreAuthorize("#oauth2.hasScope('all') OR hasPermission(null ,'saveAbility')")
   public Ability saveAbility(@RequestBody String data,HttpServletResponse response){
    ...
    @PreAuthorize("#oauth2.hasScope('all') OR hasPermission(null ,'deleteAbility')")
    ...
    @PreAuthorize("#oauth2.hasScope('all') OR hasPermission(null ,'findAbilitiesByModelId')")
    ...
    @PreAuthorize("#oauth2.hasScope('all') OR hasPermission(null ,'findAbilitiesByThreeTouple')")
